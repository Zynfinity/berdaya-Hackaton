      ...
      <HStack mt="16" justifyContent="space-between" alignItems="start">
        <VStack alignItems="start" w="100%">
          ...
          <HStack w="full" justifyContent="space-between" mt="5">
            <Text fontSize="2xl" letterSpacing="2px" fontWeight="semibold">LAPORAN 1</Text>
            {/* <ShareButton /> */}
            <HStack>
              <Button fontSize="xs">ANGGARAN</Button>
              <Button fontSize="xs">TERIMA</Button>
              <Button fontSize="xs" bg="red.400">TOLAK</Button>
            </HStack>
          </HStack>
